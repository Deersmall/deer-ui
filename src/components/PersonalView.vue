...
<!--                    <img  src="../assets/images/touxiang.png">-->
                ...
                {{user.nickname}}<i class="el-icon-arrow-down el-icon--right"></i>
                    ...
                    <el-dropdown-menu slot="dropdown" class="liList">
                        ...
                        <el-dropdown-item>
                            <span  style="width: 100%;height: 100%" @click="closedealtArea">待办</span>
                        </el-dropdown-item>
                    </el-dropdown-menu>
                </el-dropdown>
            </div>
...
<!--每日一言-->
                    <div style="text-align: center; padding: 0px 15px; font-size: 6px;font-weight: bold; flex: 2;color: #E7EAED;width: 100%;display: flex;justify-content: center;align-items: center">
                        {{sentence}}
                    </div>
<!--                    天气-->
...
<!--                有申请时候的表头-->
                <div v-show="!(this.numberOfRequest===0)" style="flex: 3;display: flex;flex-direction: column;align-items: normal;margin-top: 0px;overflow-y: auto">
